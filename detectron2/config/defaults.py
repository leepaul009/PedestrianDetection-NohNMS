...
_C.MODEL.ALLOW_BOX_OUT_OF_BOUNDARY = False
...
_C.MODEL.RPN.IGNORE_IOA = False
_C.MODEL.RPN.TOP_PROPOSALS_ALL_LEVEL = False
_C.MODEL.RPN.UPDATE_MATCHES = False
...
_C.MODEL.ROI_HEADS.IGNORE_IOA = False
...
# Overlap Box Head
# ---------------------------------------------------------------------------- #
_C.MODEL.OVERLAP_BOX_HEAD = CN()
_C.MODEL.OVERLAP_BOX_HEAD.ENABLE = False
_C.MODEL.OVERLAP_BOX_HEAD.BUILD_ON_ROI_FEATURE = True
_C.MODEL.OVERLAP_BOX_HEAD.OVERLAP_IOU_THRESHOLD = 0.3
_C.MODEL.OVERLAP_BOX_HEAD.REG_LOSS_COEFF = 0.1
_C.MODEL.OVERLAP_BOX_HEAD.PROB_LOSS_BETA = 0.1
_C.MODEL.OVERLAP_BOX_HEAD.SIGMOID_ON = True
_C.MODEL.OVERLAP_BOX_HEAD.UNIFORM_REG_DIVISOR = False
