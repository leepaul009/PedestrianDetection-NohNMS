...
CITYPERSON_CATEGORIES = [
    ...
    # {"color": [0, 0, 142], "isthing": 1, "id": 3, "name": "riders"},
    # {"color": [0, 0, 230], "isthing": 1, "id": 4, "name": "sitting"},
    # {"color": [106, 0, 228], "isthing": 1, "id": 5, "name": "unusual"},
    # {"color": [0, 60, 100], "isthing": 1, "id": 6, "name": "group"},
]
